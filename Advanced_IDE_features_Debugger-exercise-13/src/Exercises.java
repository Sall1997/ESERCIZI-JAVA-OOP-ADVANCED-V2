...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        Assertions.assertEquals(120, factorial);  //era: 120
    }

    private static int calculateFactorial(int number) {
        //Fix this code
        int result = 1;
        for (int i = number; i >= 1; i -= 1) {    // era: i-=2
            result = result * i;
        }
        return result;
    }
    ...
    private static String reverseString(String input) {
        ...
        String reversed = "";
        for (int i = input.length() - 1; i >= 0; i--) { // era i >= 1
            reversed += input.charAt(i); // era: reversed += reversed + input.charAt(i)
        }
        return reversed;
    }
    ...
    private static void exercise3() {
        ...
        Assertions.assertFalse(isPositive(0)); // l'errore era qui
